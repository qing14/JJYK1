...
import asus.com.bwie.jjyk1.adapter.ShangPinAdapter;
...
public class JiaJianView extends LinearLayout implements View.OnClickListener {
    ...
    public void setData(ShangPinAdapter shangPinAdapter, List<ShopCarBean.DataBean.ListBean> list, int position) {
    ...
    private void init(Context context) {
        ...
        View view = View.inflate(context, R.layout.jiajian_layout, null);
